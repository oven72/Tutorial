...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_add_user_t, stringdata) + ofs \
...
const QMetaObject add_user::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_add_user.data,
      qt_meta_data_add_user,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_add_user.stringdata))
