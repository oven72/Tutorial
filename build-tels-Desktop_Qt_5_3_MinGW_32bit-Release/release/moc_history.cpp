...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_history_t, stringdata) + ofs \
...
const QMetaObject history::staticMetaObject = {
    { &QListWidget::staticMetaObject, qt_meta_stringdata_history.data,
      qt_meta_data_history,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_history.stringdata))
